...
import com.compass.pb.mule.testfour.domain.pbbank.Card;
import com.compass.pb.mule.testfour.domain.pbbank.Customer;
...
public class PaymentService {
    ...
    public PaymentResponse proccessNewPayment(PaymentRequest request) {
        ...
        BankPaymentResponse bankResponse = bankPaymentService.processPaymentAtBank(bankRequest);
